package com.dynamicoders.myapplication.widget;
...
import com.dynamicoders.myapplication.R;
...
public class MotionView  extends FrameLayout {
    ...
    public void addFirstEntityAndPosition(@Nullable MotionEntity entity) {
        if (entity != null) {
            initEntityBorder(entity);
            initialFirstTranslateAndScale(entity);
            entities.add(entity);
            selectEntity(entity, true);
        }
    }
    ...
    private void initialFirstTranslateAndScale(@NonNull MotionEntity entity) {
        entity.moveToCanvasCenter();
        entity.getLayer().setScale(1);
    }
